...
@mcp.tool(tools, structured_output={"rows": [list], "status": str, "error": str})
...
@mcp.tool(tools, structured_output={"tables": [str], "error": str})
def list_tables() -> dict:
    """List all tables in the database."""
    return _run_sql("SELECT name FROM sqlite_master WHERE type='table';")


@mcp.tool(tools, structured_output={"columns": [{"name": str, "type": str}], "error": str})
